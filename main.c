...
if(n==1){// this if statement is initialised if the number 1 is inputted above
...
if(n==2){ //this if statement is initialised if the number 2 is inputted above
...
if(n==3){ //this if statement is initialised if the number 3 is inputted above
    printf("Subsitution encryption selected of (%s):\n", phrase);
}


if(n==4){ //this if statement is initialised if the number 4 is inputted abov
    printf("Substitution decryption selected of (%s):\n", phrase);  
}

if(n<1, n>4){ //this if statement is initialised if the numbers above are not selected
